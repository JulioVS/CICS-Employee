      ...
      *         NEXT INTERACTIONS -> CONTAINER FOUND (CONTINUE)
                IF LST-SAVING-PROGRAM IS EQUAL TO APP-LIST-PROGRAM-NAME
                   PERFORM 2000-PROCESS-USER-INPUT
                   EXIT
                END-IF
      *         IF BOUNCING BACK FROM 'VIEW' PAGE, RESTART CONVERSATION
                IF LST-SAVING-PROGRAM IS EQUAL TO APP-VIEW-PROGRAM-NAME
      ...
      *    SET INITIAL VALUES FOR LIST CONTAINER.
           ...
           MOVE APP-LIST-PROGRAM-NAME TO LST-SAVING-PROGRAM.
