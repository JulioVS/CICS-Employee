      ...
      *      AUDIT TRAIL 
          ...
          05 APP-AUDIT-PROGRAM-NAME     PIC X(8)  VALUE 'EAUDITP'.
          ...
          05 APP-AUDIT-TESTING-PRG-NM   PIC X(8)  VALUE 'EAUDITT'.
      *      SWITCH FILE 
          05 APP-SWITCH-TRANSACTION-ID  PIC X(4)  VALUE 'ESWI'.
          05 APP-SWITCH-PROGRAM-NAME    PIC X(8)  VALUE 'ESWITCH'.
          05 APP-SWITCH-TESTING-TRN-ID  PIC X(4)  VALUE 'ESWT'.
          05 APP-SWITCH-TESTING-PRG-NM  PIC X(8)  VALUE 'ESWITCHT'.
      *      UPDATE EMPLOYEE 
          05 APP-UPD-TRANSACTION-ID     PIC X(4)  VALUE 'EUPD'.
          05 APP-UPD-PROGRAM-NAME       PIC X(8)  VALUE 'EUPDP'.
          05 APP-UPD-MAPSET-NAME        PIC X(7)  VALUE 'EUPDMAP'.
          05 APP-UPD-MAP-NAME           PIC X(7)  VALUE 'EUPDM'.
          05 APP-UPD-CONTAINER-NAME     PIC X(16) VALUE 'UPDContainer'.
          05 APP-UPD-CHANNEL-NAME       PIC X(16) VALUE 'DHFTRANSACTION'
           .