...
- CEDA DEFINE PROGRAM(EDETMAP) GROUP(PS)
- CEDA DEFINE PROGRAM(EVIEWP) GROUP(PS)
---
- CEDA DEFINE TRANSACTION(ESON) GROUP(PS)
- CEDA DEFINE TRANSACTION(ELST) GROUP(PS)
- CEDA DEFINE TRANSACTION(EDET) GROUP(PS)
---
...
- CEDA INSTALL PROGRAM(EDETMAP) GROUP(PS)
- CEDA INSTALL PROGRAM(EVIEWP) GROUP(PS)
---
- CEDA INSTALL TRANSACTION(ESON) GROUP(PS)
- CEDA INSTALL TRANSACTION(ELST) GROUP(PS)
- CEDA INSTALL TRANSACTION(EDET) GROUP(PS)
---
...
- CEMT SET PROGRAM(EDETMAP) NEWCOPY
- CEMT SET PROGRAM(EVIEWP) NEWCOPY
